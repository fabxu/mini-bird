...
predicted_sql_path='../output/predict_mini_dev_gpt-35-turbo_cot_MySQL.json' # Replace with your predict sql json path
...
output_log_path="../output/${base_name}.txt"
...
case $sql_dialect in
  ...
  "PostgreSQL")
    ...
    ;;
  "MySQL")
    diff_json_path="../output/mini_dev_mysql.json"
    ground_truth_path="../output/mini_dev_mysql_gold.sql"
    ;;
  *)
